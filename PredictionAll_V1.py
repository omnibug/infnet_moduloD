...
x_treino, x_teste, y_treino, y_teste = train_test_split(x, y, train_size=0.7, stratify=y, random_state=5)
...
#'max_depth':2,'n_estimators':60000,'objective':'reg:linear','learning_rate':0.001,'min_child_weight':1, 'gamma':0.0, 'subsample':0.1, 'colsample_bytree':0.5, 'missing':np.nan,'silent':1 
var_model = {
             'learning_rate':0.1,
             'n_estimators':6000,
             'max_depth':1,
